...
const hero_contents = {
  ...
  short_text: (
    <>
      Selamat datang di website Unit Kegiatan Mahasiswa Paguyuban Barudak
      Komputer. PBK merupakan wadah eskalasi intelektual khususnya di bidang
      Teknologi Informasi di era society 5.0.
    </>
  ),
            ...
            <div className="col-xl-7 col-lg-7">
              <div className="tp-hero-section-box-five">
                ...
                <div
                  ...
                  data-wow-delay=".9s"
                >
                  <Link className="tp-btn mr-55" href="/tentang">
                    Tentang Kami
                  </Link>
