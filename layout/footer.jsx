...
const footer_contents = {
  ...
  widget_desc:
    "Unit Kegiatan Mahasiswa (UKM) Paguyuban Barudak Komputer Fakultas Ilmu Komputer Universitas Kuningan.",
  footer_widgets: [
    {
  ...
  copy_right_text: (
    <>
      Copyright © {new Date().getFullYear()} Paguyuban Barudak Komputer. All
      Rights Reserved
    </>
  ),
};
